...
python -m torch.distributed.launch --nproc_per_node=8 --use_env main.py --coco_path /media/homes/farjad/data/coco --epochs 10 \
 --output_dir /media/homes/farjad/repos/detr_custom_dcmha/output --batch_size 2 > log_directory/gated_mha.txt 2>&1 &
